...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/pagmo-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pagmo-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add pagmo pagmo-devel
# for installing globally
pixi global install pagmo pagmo-devel
```
...
It is possible to list all of the versions of `pagmo` available on your platform:
...
```
pixi search pagmo --channel conda-forge
```
